...
def pievienot_treneri():
    ...
    izglītība_entry = tk.Entry(logs)
    izglītība_entry.pack()

    tk.Label(logs, text="kvalifikācija:").pack()
    kvalifikācija_entry = tk.Entry(logs)
    kvalifikācija_entry.pack()
...
def treneru_logs():
    ...
    treneri_logs.title("Trenerī pārvaldība")
    treneri_logs.geometry("300x250")

    pievienot_btn = tk.Button(treneri_logs, text="Pievienot treneru", command=pievienot_treneri, width=25, height=2, bg="lightblue")
    pievienot_btn.pack(pady=10)

    meklēt_btn = tk.Button(treneri_logs, text="Meklēt treneru", command=meklēt_treneri, width=25, height=2, bg="lightgreen")
    meklēt_btn.pack(pady=10)

    dzēst_btn = tk.Button(treneri_logs, text="Dzēst treneru", command=dzēst_treneri, width=25, height=2, bg="lightyellow")
    dzēst_btn.pack(pady=10)
